...
/// Simple Panic Button screen without complex dependencies
/// Requirements: 4.1 - Hold button 3 seconds to trigger
class SimplePanicScreen extends StatefulWidget {
  final VoidCallback? onWipeComplete;

  const SimplePanicScreen({
    super.key,
    this.onWipeComplete,
  });

  @override
  State<SimplePanicScreen> createState() => _SimplePanicScreenState();
}

class _SimplePanicScreenState extends State<SimplePanicScreen>
