...
public struct DcColors {
    ...
    // MKR Brand Color - Blue
    public static let primary = UIColor(hexString: "0066CC")
    public static let highlight = UIColor.themeColor(light: UIColor(hexString: "0088FF"), dark: UIColor(hexString: "0055AA"))
    public static let colorDisabled = UIColor.themeColor(light: UIColor(white: 0.9, alpha: 1), dark: UIColor(white: 0.2, alpha: 1))
    // MKR Brand Color - Blue tinted messages
    public static let messagePrimaryColor = UIColor.themeColor(light: UIColor.rgb(red: 200, green: 220, blue: 255),
